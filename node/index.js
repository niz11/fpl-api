...
function fetchClassicLeague(
	...
	return __awaiter(this, void 0, void 0, function*() {
		try {
			const fetchWithCookieJar = node_fetch_2.default(node_fetch_1.default, session);
			const response = yield fetchWithCookieJar(
...
function fetchH2HLeagueStandings(
	session,
	leagueId,
...
function fetchSession(login, password) {
	return __awaiter(this, void 0, void 0, function*() {
		try {
			...
			validateResponse(response);
			if (cookieJar.getCookieStringSync('https://premierleague.com').includes('pl_profile')) {
				return cookieJar;
			} else {
