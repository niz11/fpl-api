...
export declare enum EventStatusDayPoints {
    LIVE = "l",
    PROVISIONAL = "p",
    CONFIRMED = "r"
}
...
export declare class IsUpdatingError extends Error {
    constructor();
}
...
export declare function fetchCurrentUser(): Promise<any>;
export declare function fetchMyTeam(entryId: number): Promise<any>;
