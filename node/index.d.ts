...
export declare function fetchClassicLeague(session: CookieJar, leagueId: number, { pageStandings, pageNewEntries, phase }?: {
    pageStandings: number;
    pageNewEntries: number;
    phase: number;
}): Promise<ClassicLeague>;
export declare function fetchH2HLeagueStandings(session: CookieJar, leagueId: number, { pageStandings, pageNewEntries }?: {
    pageStandings: number;
    pageNewEntries: number;
}): Promise<H2HLeague>;
export declare function fetchH2HMatches(session: CookieJar, leagueId: number, entryId: number, page?: number): Promise<H2HLeagueMatches>;
...
export declare function fetchSession(login: string, password: string): Promise<CookieJar>;
